...
function InsertUser(data) {
    return new Promise ((resolve, reject) => {
      let params = generalTools.CleanQuotes(generalTools.ObjectToArray(data, ['Username', 'Currency']));
...
function DeleteUser(data) {
  return new Promise ((resolve, reject) => {
    let params = generalTools.CleanQuotes(generalTools.ObjectToArray(data, ['Username']));
